...
import { executeQueries, getDataStructure, dropSQLFunction } from "../utils/DataStructure";
...
export class DataRecoveryGraph extends AbstractGraph<DataRecoveryState> {
    ...
    getGraph(): CompiledStateGraph<DataRecoveryState> {
        ...
        subGraphBuilder
            ...
            .addNode("create_plv8_function", async (state) => await createPLV8Function(state))
