...
export async function addDocuments(pageContents: string[], metadata: Record<string, any>[]) {
  if (pageContents.length !== metadata.length) {
    throw new Error("The number of page contents must match the number of metadata objects.");
  }
