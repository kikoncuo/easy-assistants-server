...
- getData: Use this tool exclusively when a user requests the creation of a segment or a table. It requires specific input parameters, including the names and structures of tables retrieved from the getTables tool and a detailed description of the segment.
...
"Create a graph to highlight my top 10 customers last year, my tables are Transactions, Users and Products", the plan could be: 
[
  {{
    stepId: "#E1",
    description: "Get the top 10 customers from the Transactions and Users data",
    toolName: "getData",
    toolParameters: [ "Transactions, Users" ],
  }}, {{
    stepId: "#E2",
