        ...
        percentage: {
          ...
          properties: {
            exist: {
              type: "boolean",
              description:
                "Indicates if there is an increment or decreased for that value",
            },
            value: {
              type: "string",
              description:
                "Indicated the value, can be positive or negative. If percentage is false, the value is always 0",
            },
          },
        },
      },
