...
function connectToServer() {
  ...
  ws.on('open', () => {
    ...
    ws?.send(JSON.stringify({ type: 'configure', configData: ["csv_,at_", "postgresql://postgres.dbhhziresrambrdyptjh:hohne8-Tixpoc-dockah@aws-0-eu-central-1.pooler.supabase.com:6543/postgres"] }));
    promptUserInput();
  });
